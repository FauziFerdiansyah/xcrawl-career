...
def main():
    ...
    with sync_playwright() as p:
        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            # output
            #########
            # business_list.save_to_excel(f"output/xgoogle_maps_data_{search_for}".replace(' ', '_'))
            # business_list.save_to_csv(f"output/xgoogle_maps_data_{search_for}".replace(' ', '_'))

            business_list.save_to_excel("google_maps_data")
            # business_list.save_to_csv("output/google_maps_data")
